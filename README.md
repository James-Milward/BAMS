...
#### MLD is computed as the maximum depth where surface-referenced potential density remains <= 10-meter potential density plus 0.03 kg m-3, following de Boyer Montegut et al (2004). MLD fields and calculated and saved out in `MixedLayer_RG_Calculation_CreateFiles_BAMS2025.ipynb`.
